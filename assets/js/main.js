...
/*==================== practices MODAL ====================*/
const modalViews = document.querySelectorAll('.practices__modal'),
  modalBtns = document.querySelectorAll('.practices__button'),
  modalCloses = document.querySelectorAll('.practices__modal-close')
...
/*==================== locations SWIPER  ====================*/
let swiperlocations = new Swiper('.locations__container', {
  cssMode: true,
  loop: true,
